...
//Это не таск1 юнита 2 а прорешивание примеров юнита 2 + сортировки
//Использование методов кроме мэин,
//Метод печать массивов
//метод прямая сортировка
//метод прямая сортировка 2
